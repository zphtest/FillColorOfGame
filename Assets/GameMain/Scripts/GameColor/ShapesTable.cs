...
namespace IndieStudio.DrawingAndColoring.Logic
{
	...
	public class ShapesTable : MonoBehaviour
	{
		...
		public void SetProcedure(ProcedureMenu procedureMenu)
		{
			m_ProcedureMenu = procedureMenu;
		}
		...
		private void CreateShapes ()
		{
				...
				for (int i = 0; i < ShapesManager.instance.shapes.Count; i++) {
						...
						tableShapeGameObject.GetComponent<Button> ().onClick.AddListener (
							() =>
							{
								//var uiEvent = GameObject.FindObjectOfType<UIEvents>();
								//uiEvent.AlbumShapeEvent(tableShapeGameObject.GetComponent<TableShape>());
